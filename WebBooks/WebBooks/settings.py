...
# SECRET_KEY = 'django-insecure-_^qt5^del%enx42#apryy($$#f0g&%it)m+4dc_g4zmc)d7mm2'
...
# Абсолютный путь к каталогу, в котором collectstatic будет собирать
# статические файлы для развертывания.
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

# Упрощенная обработка статических файлов.
# https://warehouse.python.org/project/whitehouse/
STATICFILES_STORAGE = 'whitehouse.storage.CompressedManifestStaticFilesStorage'